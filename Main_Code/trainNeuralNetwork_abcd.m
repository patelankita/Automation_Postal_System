...
P = [a1 a2 a3 a4 a5 b1 b2 b3 b4 b5 b6 c1 c2 c3 c4 c5 d1 d2 d3 d4 d5 d6];

clear a1 a2 a3 a4 a5 b1 b2 b3 b4 b5 b6 c1 c2 c3 c4 c5 d1 d2 d3 d4 d5 d6;
...
net = newff(pr,[50 22],{'tansig','tansig'},'traingdx'); 
...
net_abcd_1 = train(net,P,tg); 
y = sim(net_abcd_1, P);
save thenet_abcd_1 net_abcd_1; 
% save thep P; 
